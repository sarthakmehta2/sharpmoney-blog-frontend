...
export function Blogpost({ bloglist }) {
  ...
  const postUrl = `https://sharpmoney-blog-frontend.vercel.app/blog/${blog.slug}`; // Update this to your actual front-end URL
...
const iconStyle = {
  ...
  return (
    ...
    {blog.imageUrl && <img src={url+`${blog.imageUrl}`} alt={blog.title} style={imageStyle}/>}<br></br>
